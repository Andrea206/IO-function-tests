...
sleep 10
./partestcputenancy.sh 10 10 > ~/memscalecold$i$timestamp-$memory-$totalruns.csv
aws lambda update-function-configuration --function-name IO --timeout 240 > /dev/null
done
}
...
memscalecold 1024 10
echo "Ten cold runs, 1152mb-----------------------------------------------------------------------------------------"
memscalecold 1152 10
echo "Ten cold runs, 1280mb-----------------------------------------------------------------------------------------"
memscalecold 1280 10
echo "Ten cold runs, 1408mb-----------------------------------------------------------------------------------------"
memscalecold 1408 10
echo "Ten cold runs, 1536mb-----------------------------------------------------------------------------------------"
memscalecold 1536 10
